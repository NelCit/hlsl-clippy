---
title: "excess-interpolators: A vertex-to-pixel (or vertex-to-geometry, vertex-to-hull, mesh-to-pixel) interface struct whose total occupied `TEXCOORDn` slot count…"
date: 2026-05-02
