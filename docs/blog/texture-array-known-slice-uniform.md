---
title: "texture-array-known-slice-uniform: Calls to `Texture2DArray.Sample(sampler, float3(uv, K))` or `Texture2DArray.SampleLevel(sampler, float3(uv, K), lod)` where the slice coordinate…"
date: 2026-05-02
