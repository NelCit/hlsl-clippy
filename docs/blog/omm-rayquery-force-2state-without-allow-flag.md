---
title: "omm-rayquery-force-2state-without-allow-flag: A `RayQuery<RAY_FLAG_FORCE_OMM_2_STATE>` template instantiation, or a `TraceRayInline` call with the equivalent runtime ray flag,…"
date: 2026-05-02
