...
public:
    ...
    void on_reflection(const AstTree& tree,
        ...
        // ADR 0020 sub-phase A v1.3.1 — needs the AST to find the struct
        // declaration the StructuredBuffer references for stride inference.
        // Bail silently when no tree is available (`.slang` until sub-phase B).
