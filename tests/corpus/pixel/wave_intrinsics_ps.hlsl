// Source: https://github.com/microsoft/DirectX-Graphics-Samples/blob/ca3f7f4e0a73b69f96371fef0f4a08958b278936/Samples/Desktop/D3D12SM6WaveIntrinsics/src/wave.hlsl
// License: MIT
// Original author: Microsoft
// Profile: ps_6_0
// Stage: pixel
// Notes: SM 6.0 wave-intrinsics demo pixel shader; exercises WaveGetLaneIndex, WaveIsFirstLane, WaveActiveBallot, WaveActiveSum, WavePrefixSum, and QuadReadAcross*
// verified: pending

/*
*  Note that SM6 is not supported in the integrated shader compiling functionality in Visual Studio 2017.
...
float4 PSMain(PSInput input) : SV_TARGET
{
    ...
    switch (renderMode)
    {
        ...
        case 6:
        {
            ...
            // Broadcast the color in first lane to the wave.
