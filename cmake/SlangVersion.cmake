...
# into `$HOME/.cache/shader-clippy/slang/<version>/` and `cmake/UseSlang.cmake`
...
# `tools/fetch-slang.sh` with a regex against `set(SHADER_CLIPPY_SLANG_VERSION
# "<ver>")`. Keep that line single-line and quoted.

set(SHADER_CLIPPY_SLANG_VERSION "2026.7.1" CACHE STRING
    "Pinned Slang release version (downloaded by tools/fetch-slang.{sh,ps1}).")
mark_as_advanced(SHADER_CLIPPY_SLANG_VERSION)
